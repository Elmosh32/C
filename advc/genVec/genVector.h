...
typedef enum Vector_Result
{
	...
	VECTOR_ITEM_UNINITIALIZED_ERROR,
	VECTOR_ALLOCATION_ERROR,	/**< malloc error on grow/shrink   */
	VECTOR_REALLOCATION_FAILED, /**< realloc error on grow/shrink   */
 ...
 * @param[in] _index - index of item to get value from. the index of first element is 1
