...
void FreeListFuncElement(void *_element)
{
    free(_element);
}
...
static void ListItrBeginT1();
static void ListItrBeginT2();
static void ListItrBeginT3();

static void ListItrEndT1();
static void ListItrEndT2();
static void ListItrEndT3();
...
static void ListSizeT3()
{
    ...
    ListDestroy(&list, FreeListFuncElement);
}
...
static void ListItrBeginT1()
{
    ...
    {
        printf("(1)ListItrBegin test\t=>\tFAIL\n");
    }
    else
    {
        printf("(1)ListItrBegin test\t=>\tPASS\n");
    }
}
...
static void ListItrBeginT2()
{
    ...
    if ((var = ListItrBegin(list)) == NULL)
    {
        printf("(2)ListItrBegin test\t=>\tFAIL\n");
    }
    else
    {
        printf("(2)ListItrBegin test\t=>\tPASS\n");
    }
...
static void ListItrBeginT3()
{
    ...
    if ((var = ListItrBegin(list)) == NULL)
    {
        printf("(3)ListItrBegin test\t=>\tFAIL\n");
    }
    else
    {
        printf("(3)ListItrBegin test\t=>\tPASS\n");
    }
...
static void ListItrEndT1()
{
    ...
    {
        printf("(1)ListItrEnd test\t=>\tFAIL\n");
    }
    else
    {
        printf("(1)ListItrEnd test\t=>\tPASS\n");
    }
}
...
static void ListItrEndT2()
{
    ...
    if ((var = ListItrEnd(list)) == NULL)
    {
        printf("(2)ListItrEnd test\t=>\tFAIL\n");
    }
    else
    {
        printf("(2)ListItrEnd test\t=>\tPASS\n");
    }
    ListDestroy(&list, FreeListFuncElement);
}
...
static void ListItrEndT3()
{
    ...
    if ((var = ListItrEnd(list)) == NULL)
    {
        printf("(3)ListItrEnd test\t=>\tFAIL\n");
    }
    else
    {
        printf("(3)ListItrEnd test\t=>\tPASS\n");
    }
