...
/**
 * @brief Finds the first element in a range satisfying a predicate
 ...
 * @details Merge elements from two sub lists defined by [_firstborn.._firstEnd)
 * and [_secondBegin.._secondEnd) in optionally sorted order using _less function.
