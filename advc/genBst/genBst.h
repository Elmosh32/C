#ifndef __GEN_BST_H__
#define __GEN_BST_H__
...
typedef enum
{
    BST_TRAVERSAL_PRE_ORDER = 0,
    BST_TRAVERSAL_IN_ORDER,
    BST_TRAVERSAL_POST_ORDER
} BSTreeTraversalMode;
 ...
 * @return : 0 if are not the same any node zero value if iterators are the same
 */
 ...
 * @params _mode : Traversal mode - TREE_TRAVERSAL_PREORDER, TREE_TRAVERSAL_IN-ORDER or TREE_TRAVERSAL_POSTORDER
